...
const Hero: React.FC = () => {
    return (
        <main className="px-8 flex flex-col gap-10">
            <div className="bg-slate-300 flex max-md:flex-col gap-10 p-10  items-center rounded-lg shadow-md">
                <div className="px-10 w-3/4">
                    <Carousel>
                        <CarouselContent>
                            <CarouselItem>
                                <img src="https://www.bibiled.com/wp-content/uploads/2024/06/Taxi-LED-displays-help-progress-smart-cities-www.bibiled.com-1.jpg" alt="image" />
                            </CarouselItem>
                            <CarouselItem>
                                <img src="https://www.ddw.net/uploads/image/65ea8d8d7c5fe.png" alt="image" />

                            </CarouselItem>
                            <CarouselItem>
                                <img src="https://www.billups.com/hs-fs/hubfs/How%20Taxi%20and%20Rideshare%20Advertising%20Work%204%20(1).jpg?width=853&height=571&name=How%20Taxi%20and%20Rideshare%20Advertising%20Work%204%20(1).jpg" alt="image" />
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="font-[sans-serif] max-w-[410px] h-auto p-6 rounded-lg mx-auto shadow-[0_6px_18px_-6px_rgba(193,195,248)] bg-white relative mt-12">
                                    <img src="https://readymadeui.com/profile_2.webp" className="w-16 h-16 rounded-full absolute right-0 left-0 mx-auto -top-7" />
