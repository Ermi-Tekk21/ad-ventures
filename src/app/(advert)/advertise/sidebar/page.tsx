...
const Sidebar: React.FC = () => {
    ...
    return (
        <div className="w-[250px] relative flex flex-col gap-10 h-screen bg-sidebarBg items-center pt-6 z-50">
            <div className="flex flex-col gap-4 items-center">
                <h1 className="text-2xl font-extrabold text-white">Ad Ventures</h1>
            ...
            <div className="flex text-white justify-center">
                <ul className="flex flex-col gap-6">
                    <li className={`flex gap-2 ${pathname === "/advertise" ? "font-bold" : "font-light"}`}>
                        ...
                        {
                            pathname === "/advertise" && (
                                <hr className="-ml-4 border-4 border- h-6" />
                            )
                        }
