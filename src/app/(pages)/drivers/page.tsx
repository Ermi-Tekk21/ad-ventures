...
const DriverPage: React.FC = () => {
    return (
        <main className="px-24 flex flex-col gap-4 py-16">
            <div className="flex flex-col md:flex-row justify-center items-center p-8 pt-20 bg-gray-50 rounded-md shadow-md">
                ...
                <div className="md:w-1/2 p-4 flex flex-col gap-6">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-lg mb-4 text-gray-600">
                            Whether you're driving around the city for work or errands, your vehicle becomes a mobile billboard, helping you earn while you’re on the go. It’s a simple and flexible way to boost your income with no added hassle.
                        </p>
                    </div>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center p-8 pt-20 bg-gray-100 rounded-md shadow-md">
                ...
                <div className="md:w-1/2 p-4 flex flex-col gap-6">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-lg mb-4 text-gray-600">
                            It's an easy and profitable way to use your car, with no upfront costs or special requirements – just drive as you normally would!
                        </p>
                    </div>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center p-8 pt-20 bg-gray-100 rounded-md shadow-md">
                ...
                <div className="md:w-1/2 p-4 flex flex-col gap-6">
                    ...
                    <div className="flex flex-col">
                        <p className="text-lg mb-4 text-gray-600">
                            Your vehicle is more than just a way to get from point A to point B. By partnering with Ad Ventures, you're joining a network of drivers making a real impact. With every trip, you’re helping brands reach their target audience, and in return, you get to enjoy the rewards.
                        </p>
                        <p className="text-lg mb-4 text-gray-600">
                            It’s a win-win situation that transforms your everyday driving into something with real purpose. </p>
                    </div>
