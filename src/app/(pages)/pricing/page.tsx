...
const PricingSection: React.FC = () => {
    return (
        <div className="pt-40 px-20 pb-10">
            <div className="flex flex-col px-16 text-center justify-center">
            ...
            <div className="flex justify-around gap-8">
                {/* Pricing Option 1 */}
                <div className="border border-gray-300 rounded-lg p-6 bg-white w-full shadow-md">
                ...
                {/* Pricing Option 3 */}
                <div className="border border-gray-300 rounded-lg w-full p-6 bg-white shadow-md">
